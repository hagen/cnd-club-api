...
require('dotenv').config({
  path: path.resolve(__dirname, '../../../env/.env.test.prod')
});
...
describe(fnName, () => {
  let mStart = moment().subtract(2, 'weeks');
  let start = mStart.format('YYYY-MM-DD');
  let end = mStart.add(1, 'month').format('YYYY-MM-DD');
